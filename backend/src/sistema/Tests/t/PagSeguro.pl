#Alterando o pacote
use Controller::Financeiro::PagSeguro;
$system = new Controller::Financeiro::PagSeguro;
...
$system->setting('pagseguro_user','milhomem at is4web.com.br');
$system->setting('pagseguro_pass','03FAE84032794BB4A4'); 
...
$system->returnURL('http://debugger.is4web.com.br/sistema/TESTE_SUITE.cgi?module=PagSeguro');
