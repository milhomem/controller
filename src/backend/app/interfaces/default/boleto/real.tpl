    ...
    <td width="66%"> 
      <div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
        <table width='640' border='0' cellspacing='0' cellpadding='1'>
          <tr> 
            <td valign='top' width='250'> <table width='250' border='0' cellspacing='0' cellpadding='0'>
                <tr> 
                  <td width='175'><img src='{url_tpl}/images/logo_356.gif' width='175' height='30'></td>
                  <td width='10'> <div align='center'><img src='{url_tpl}/images/separador.gif' width='5' height='30'></div></td>
                  <td width='79'> <div align='center'><img src='{url_tpl}/images/numero_356.gif' width='63' height='30'></div></td>
        ...
        <table width='640' border='1' cellspacing='0' cellpadding='2'>
          <tr valign='top'> 
            <td colspan='5'><font face='Arial, Helvetica, sans-serif' size='1'>CEDENTE<br>
              ...
              {cedente} </font></b></td>
            <td><font face='Arial, Helvetica, sans-serif' size='1'>VENCIMENTO<br>
          ...
          <tr valign='top'> 
            ...
            <td width='101'><font size='1' face='Arial, Helvetica, sans-serif'>DATA 
              ...
              {datadoc}</font></b></td>
            <td><font face='Arial, Helvetica, sans-serif' size='1'>AGENCIA 
                / COD. CEDENTE</font> 
          ...
          <tr valign='top'> 
            ...
            <td><font face='Arial, Helvetica, sans-serif' size='1'>NOSSO 
              N&Uacute;MERO<br>
          ...
          <tr valign='top'> 
            ...
            <td width='101'><font face='Arial, Helvetica, sans-serif' size='1'>(+)MORA 
              / MULTA</font></td>
            <td><font face='Arial, Helvetica, sans-serif' size='1'>(=)VALOR 
              COBRADO</font></td>
          </tr>
        </table>
        ...
        <table width='640' border='0' cellspacing='0' cellpadding='1'>
          ...
          <tr> 
            <td valign='top' colspan='2'> <table width='640' border='1' cellspacing='0' cellpadding='1'>
                <tr> 
                  <td colspan='5'><font face='Arial, Helvetica, sans-serif' size='1'>LOCAL 
                      DE PAGAMENTO<br>
                      </font> <font face='Verdana, Arial, Helvetica, sans-serif' size='1'> 
                      <b> Pagável em qualquer banco até o vencimento.<br>
                      Após o vencimento pagável apenas no Banco Real ABN AMRO.</b></font></td>
                  <td width='146' valign='top'> <font face='Arial, Helvetica, sans-serif' size='1'>VENCIMENTO<br>
                    </font> <div align='right'><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'><br />
                      {vencimento}</font></b></div></td>
                </tr>
                <tr valign='top'> 
                  <td colspan='5'><font face='Arial, Helvetica, sans-serif' size='1'>CEDENTE<br>
                  ...
                  {cedente}</font></b></td>
                  <td width='146' valign="top"><font face='Arial, Helvetica, sans-serif' size='1'>AGENCIA 
                      / COD. CEDENTE<br />
                  </font>
                    <div align='right'><font face='Verdana, Arial, Helvetica, sans-serif'><b><font size='1'>{agencia}/{conta}/{dvconta}</font></b></font></div></td>
                </tr>
                <tr valign='top'> 
                  <td width='105'><font size='1' face='Arial, Helvetica, sans-serif'>DATA 
                    DOCUMENTO<br>
                    </font><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'> 
                  {datadoc}</font></b></td>
                  <td width='116'><font size='1' face='Arial, Helvetica, sans-serif'>NUM 
                    DO DOC<br>
                    </font><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'> 
                  {numerodoc}</font></b></td>
                  <td width='79'><font size='1' face='Arial, Helvetica, sans-serif'>ESPECIE 
                  ...
                  Sim</font></b></td>
                  <td width='81'><font size='1' face='Arial, Helvetica, sans-serif'>DATA 
                    PROCES.<br>
                    </font><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'> 
                  {datadoc}</font></b></td>
                  <td width='146' valign='top'><font face='Arial, Helvetica, sans-serif' size='1'>NOSSO 
                    N&Uacute;MERO<br>
                    </font><font face='Arial, Helvetica, sans-serif' size='1'> 
                    <div align='right'> <font face='Verdana, Arial, Helvetica, sans-serif'><b> 
                      {nossonum}</b></font></div>
                ...
                <tr valign='top'> 
                  <td width='105'> <font face='Arial, Helvetica, sans-serif' size='1'>USO 
                    DO BANCO </font></td>
                  <td width='116'><font size='1' face='Arial, Helvetica, sans-serif'>CARTEIRA<br>
                    </font><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'> 
                  {carteira}</font></b></td>
                  <td width='79'><font face='Arial, Helvetica, sans-serif' size='1'>ESP&Eacute;CIE<br>
                    </font><b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'> 
                  {especie}</font></b></td>
                  <td width='75'><font size='1' face='Arial, Helvetica, sans-serif'>QUANTIDADE</font></td>
                  <td width='81'><font size='1' face='Arial, Helvetica, sans-serif'>VALOR</font></td>
                  <td width='146' valign='top'><font face='Arial, Helvetica, sans-serif' size='1'>(=)VALOR 
                    DOCUMENTO
                    </font><font face='Verdana, Arial, Helvetica, sans-serif' size='1'>&nbsp; 
                    </font><font face='Arial, Helvetica, sans-serif' size='1'> 
                    <div align='right'> <font face='Verdana, Arial, Helvetica, sans-serif'><b> 
                ...
                <tr valign='top'> 
                  <td rowspan='5' colspan='5'><font face='Arial, Helvetica, sans-serif' size='1'>INSTRU&Ccedil;&Otilde;ES 
                  ...
                  <td width='146' valign='top'><font face='Arial, Helvetica, sans-serif' size='1'>(-)DESCONTO/ABATIMENTO<br>
                  &nbsp; </font></td>
                </tr>
                <tr> 
                  <td width='146' valign='top'> <div align='left'><font face='Arial, Helvetica, sans-serif' size='1'> 
                      (-)OUTRAS DEDU&Ccedil;&Otilde;ES&nbsp;<br>
                  &nbsp; </font></div></td>
                </tr>
                <tr> 
                  <td width='146' valign='top'><font face='Arial, Helvetica, sans-serif' size='1'>(+)MORA 
                    / MULTA<br />
                 &nbsp; </font></td>
                </tr>
                <tr> 
                  <td width='146' valign='top'><font face='Arial, Helvetica, sans-serif' size='1'>(+)OUTROS 
                      ACR&Eacute;CIMOS<br>
                  &nbsp; </font></td>
                </tr>
                <tr> 
          ...
          <tr> 
            <td valign='top' colspan='2'> <table width='640' border='1' cellspacing='0' cellpadding='0'>
              <!--DWLayoutTable-->
                <tr> 
                  <td width="636" height="49" valign='top'> <font size='1' face='Arial, Helvetica, sans-serif'>SACADO</font><br> 
                    <b><font face='Verdana, Arial, Helvetica, sans-serif' size='1'> 
                {sacado} - {cpfcnpj} <br>
                    {endereco} - {cep}<br>
                {cidade} - {estado}
