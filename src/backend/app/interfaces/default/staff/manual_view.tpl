  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr valign="middle">
      <td valign="top"> <table width="145" border="0" align="right" cellpadding="4" cellspacing="0">
          ...
          <tr> 
            <td colspan="2">Aqui voc&ecirc; poder&aacute; salvar e editar as op&ccedil;&otilde;es da documenta&ccedil;&atilde;o da &aacute;rea de clientes. </td>
          </tr>
          <tr> 
...
<tr bgcolor="#DBDBDB"><td><div align="center"><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#333333">{nome}</font></b></div></td>
</tr><tr><td> <table width="100%" height="125" border="0" cellpadding="3">
  <tr> <td height="90"><div align="center">
    <p><font size="1">      Nome:</font><font size="1"><br>
      </font>
      <input name="nome" type="text" value="{nome}" size="30">
      <font size="1">
      <br>
      <br>
      {desc}
        <br>
        <br>
        <input type="hidden" name="do"  value="manualsave" >
        ...
        <a href=staff.cgi?do=manualrem&id={id}&sid={sid}>[ REMOVER ]</a></font></div></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td colspan="2">&nbsp;</td>
