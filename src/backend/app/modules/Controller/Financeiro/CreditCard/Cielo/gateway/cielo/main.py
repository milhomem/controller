...
class PaymentAttempt(object):
    ...
    def __init__(self, affiliation_id, api_key, total, card_type, installments, order_id, card_number,
                exp_month, exp_year, card_holders_name, transaction=CASH, cvc2=None, cvc2_indicator=1, soft_descriptor='', sandbox=False):
        ...
        self.cvc2 = cvc2
        self.cvc2_indicator = cvc2_indicator
    ...
    def capture(self):
        ...
        tid = str(dom.getElementsByTagName('tid')[0].childNodes[0].data)
